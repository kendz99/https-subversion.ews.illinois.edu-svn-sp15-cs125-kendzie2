//UIUC CS125 FALL 2014 MP. File: MyScriptPrinter.java, CS125 Project: Challenge2-Hollywood, Version: 2015-02-09T07:50:10-0600.598389938
/**
...
public class MyScriptPrinter {
	...
	public static void main(String[] args) {
		...
		while (false == TextIO.eof()) {
			...
			if (output == true)
				TextIO.putln(name.toUpperCase() + ":" + "\"" + line + "\""); // Only print the line if 'output' is true
			
			if (line.indexOf(name.toUpperCase()) >= 0)
